...
class OxfordpetsDataModule(L.LightningDataModule):
    DATASET_SUBDIR = 'oxfordpets'
    ...
    def setup(self, stage: str = None):
        splits_file = Path(self.data_dir) / 'split_zhou_OxfordPets.json'
        with open(splits_file) as f:
            splits_info = json.load(f)

        if self.use_few_shot:
            self.train_ds = OxfordpetsDataset(
        ...
        self.test_ds = OxfordpetsDataset(
            image_dir=self.data_dir / 'images',
