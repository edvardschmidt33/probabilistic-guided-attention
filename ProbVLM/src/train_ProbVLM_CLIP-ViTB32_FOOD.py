...
from cache_embeddings_from_loader_food import cache_embeddings_from_loaders
...
if __name__ == '__main__':
    ...
    # Step 1: Cache embeddings, comment/uncomment if embeddings needs to be computed
    ...
    train_loader, val_loader = create_dataloaders(train_split_dir, batch_size=65536, num_workers=12, split_train_val=True)

    # Load test set as full loader
    test_loader = create_dataloaders(test_split_dir, batch_size=65536, num_workers=12, split_train_val=False)
    ...
    train_ProbVLM(
        ...
        num_epochs=200,
        eval_every=5,
        ckpt_path='/cephyr/users/schmidte/Alvis/Paric_nolavis/ckpt/ProbVLM_food-101',
        T1=1e0,
        T2=1e-4,
