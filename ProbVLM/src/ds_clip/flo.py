"""FLO image-to-caption retrieval dataset code"""
...
def prepare_flo_dataloaders(dataloader_config, dataset_root, caption_root, vocab_path=None):
    """
    Prepare FLO dataloaders for training, validation and testing.
    
    Args:
        dataloader_config: Configuration for dataloaders
        dataset_root: Root directory of the FLO dataset
