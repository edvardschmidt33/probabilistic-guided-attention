...
class CUBCaption(Dataset):
    ...
    def __init__(self, image_root, caption_root,
        ...
        for bird_name in os.listdir(image_root):
            if bird_name[0].isdigit():
                # Extract the class number, assuming the folder name starts with a number followed by a period
    ...
    def __getitem__(self, index):
        ...
        return img, target, self.index_to_class[index], index, full_img_path
